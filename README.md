...
[goji.go](github.com/andy2046/goji/goji.go) [int.go](github.com/andy2046/goji/int.go) 





## <a name="Concat">func</a> [Concat](github.com/andy2046/goji/goji.go?s=2395:2408#L104)
``` go
func Concat()
```
...
## <a name="Difference">func</a> [Difference](github.com/andy2046/goji/goji.go?s=5676:5771#L253)
``` go
...
## <a name="Every">func</a> [Every](github.com/andy2046/goji/goji.go?s=2590:2636#L110)
``` go
...
## <a name="Fill">func</a> [Fill](github.com/andy2046/goji/goji.go?s=4280:4334#L179)
``` go
...
## <a name="Filter">func</a> [Filter](github.com/andy2046/goji/goji.go?s=1414:1488#L62)
``` go
...
## <a name="FindIndex">func</a> [FindIndex](github.com/andy2046/goji/goji.go?s=4819:4886#L207)
``` go
...
## <a name="FindLastIndex">func</a> [FindLastIndex](github.com/andy2046/goji/goji.go?s=5172:5243#L229)
``` go
...
## <a name="Includes">func</a> [Includes](github.com/andy2046/goji/goji.go?s=1862:1908#L80)
``` go
...
## <a name="Intersection">func</a> [Intersection](github.com/andy2046/goji/goji.go?s=6141:6238#L275)
``` go
...
## <a name="Join">func</a> [Join](github.com/andy2046/goji/goji.go?s=3860:3921#L163)
``` go
...
## <a name="Map">func</a> [Map](github.com/andy2046/goji/goji.go?s=2104:2132#L91)
``` go
...
## <a name="Max">func</a> [Max](github.com/andy2046/goji/goji.go?s=258:280#L20)
``` go
...
## <a name="Min">func</a> [Min](github.com/andy2046/goji/goji.go?s=157:179#L12)
``` go
...
## <a name="Range">func</a> [Range](github.com/andy2046/goji/goji.go?s=410:440#L28)
``` go
...
## <a name="Reverse">func</a> [Reverse](github.com/andy2046/goji/goji.go?s=1112:1152#L51)
``` go
...
## <a name="Shuffle">func</a> [Shuffle](github.com/andy2046/goji/goji.go?s=2297:2337#L99)
``` go
...
## <a name="Slice">func</a> [Slice](github.com/andy2046/goji/goji.go?s=3251:3312#L135)
``` go
...
## <a name="Some">func</a> [Some](github.com/andy2046/goji/goji.go?s=2878:2923#L122)
``` go
...
## <a name="Sort">func</a> [Sort](github.com/andy2046/goji/goji.go?s=878:941#L45)
``` go
...
## <a name="Int">type</a> [Int](github.com/andy2046/goji/int.go?s=96:113#L11)
``` go
type Int struct{}
```
...
### <a name="NewInt">func</a> [NewInt](github.com/andy2046/goji/int.go?s=289:307#L20)
``` go
func NewInt() *Int
```
...
### <a name="Int.Concat">func</a> (\*Int) [Concat](github.com/andy2046/goji/int.go?s=3523:3562#L189)
``` go
...
### <a name="Int.Difference">func</a> (\*Int) [Difference](github.com/andy2046/goji/int.go?s=9681:9736#L493)
``` go
...
### <a name="Int.Drop">func</a> (\*Int) [Drop](github.com/andy2046/goji/int.go?s=8320:8364#L415)
``` go
...
### <a name="Int.Equal">func</a> (\*Int) [Equal](github.com/andy2046/goji/int.go?s=11751:11789#L609)
``` go
...
### <a name="Int.Every">func</a> (\*Int) [Every](github.com/andy2046/goji/int.go?s=3723:3781#L200)
``` go
...
### <a name="Int.Fill">func</a> (\*Int) [Fill](github.com/andy2046/goji/int.go?s=4251:4312#L223)
``` go
...
### <a name="Int.Filter">func</a> (\*Int) [Filter](github.com/andy2046/goji/int.go?s=411:471#L25)
``` go
...
### <a name="Int.Find">func</a> (\*Int) [Find](github.com/andy2046/goji/int.go?s=721:785#L39)
``` go
...
### <a name="Int.FindIndex">func</a> (\*Int) [FindIndex](github.com/andy2046/goji/int.go?s=1028:1107#L51)
``` go
...
### <a name="Int.FindLastIndex">func</a> (\*Int) [FindLastIndex](github.com/andy2046/goji/int.go?s=1449:1532#L74)
``` go
...
### <a name="Int.ForEach">func</a> (\*Int) [ForEach](github.com/andy2046/goji/int.go?s=1854:1905#L97)
``` go
...
### <a name="Int.From">func</a> (\*Int) [From](github.com/andy2046/goji/int.go?s=3044:3102#L161)
``` go
...
### <a name="Int.Head">func</a> (\*Int) [Head](github.com/andy2046/goji/int.go?s=8598:8638#L432)
``` go
...
### <a name="Int.Includes">func</a> (\*Int) [Includes](github.com/andy2046/goji/int.go?s=2046:2090#L104)
``` go
...
### <a name="Int.IndexOf">func</a> (\*Int) [IndexOf](github.com/andy2046/goji/int.go?s=2288:2348#L115)
``` go
...
### <a name="Int.Initial">func</a> (\*Int) [Initial](github.com/andy2046/goji/int.go?s=8759:8796#L441)
``` go
...
### <a name="Int.Intersection">func</a> (\*Int) [Intersection](github.com/andy2046/goji/int.go?s=10056:10101#L513)
``` go
...
### <a name="Int.Join">func</a> (\*Int) [Join](github.com/andy2046/goji/int.go?s=4718:4768#L251)
``` go
...
### <a name="Int.Last">func</a> (\*Int) [Last](github.com/andy2046/goji/int.go?s=8910:8950#L451)
``` go
...
### <a name="Int.LastIndexOf">func</a> (\*Int) [LastIndexOf](github.com/andy2046/goji/int.go?s=2700:2764#L138)
``` go
...
### <a name="Int.Map">func</a> (\*Int) [Map](github.com/andy2046/goji/int.go?s=5051:5101#L266)
``` go
...
### <a name="Int.Nth">func</a> (\*Int) [Nth](github.com/andy2046/goji/int.go?s=9138:9187#L462)
``` go
...
### <a name="Int.Of">func</a> (\*Int) [Of](github.com/andy2046/goji/int.go?s=3367:3400#L179)
``` go
...
### <a name="Int.Pop">func</a> (\*Int) [Pop](github.com/andy2046/goji/int.go?s=5262:5308#L277)
``` go
...
### <a name="Int.Pull">func</a> (\*Int) [Pull](github.com/andy2046/goji/int.go?s=9436:9483#L482)
``` go
...
### <a name="Int.Push">func</a> (\*Int) [Push](github.com/andy2046/goji/int.go?s=5506:5558#L286)
``` go
...
### <a name="Int.Reduce">func</a> (\*Int) [Reduce](github.com/andy2046/goji/int.go?s=5782:5855#L298)
``` go
...
### <a name="Int.ReduceRight">func</a> (\*Int) [ReduceRight](github.com/andy2046/goji/int.go?s=6087:6165#L310)
``` go
...
### <a name="Int.Remove">func</a> (\*Int) [Remove](github.com/andy2046/goji/int.go?s=10631:10691#L546)
``` go
...
### <a name="Int.Reverse">func</a> (\*Int) [Reverse](github.com/andy2046/goji/int.go?s=6332:6369#L323)
``` go
...
### <a name="Int.Shift">func</a> (\*Int) [Shift](github.com/andy2046/goji/int.go?s=6565:6613#L333)
``` go
...
### <a name="Int.Shuffle">func</a> (\*Int) [Shuffle](github.com/andy2046/goji/int.go?s=7993:8024#L404)
``` go
...
### <a name="Int.Slice">func</a> (\*Int) [Slice](github.com/andy2046/goji/int.go?s=7195:7252#L360)
``` go
...
### <a name="Int.Some">func</a> (\*Int) [Some](github.com/andy2046/goji/int.go?s=3965:4022#L211)
``` go
...
### <a name="Int.Sort">func</a> (\*Int) [Sort](github.com/andy2046/goji/int.go?s=7662:7719#L392)
``` go
...
### <a name="Int.String">func</a> (\*Int) [String](github.com/andy2046/goji/int.go?s=8186:8225#L410)
``` go
...
### <a name="Int.Tail">func</a> (\*Int) [Tail](github.com/andy2046/goji/int.go?s=10853:10887#L559)
``` go
...
### <a name="Int.Take">func</a> (\*Int) [Take](github.com/andy2046/goji/int.go?s=11025:11069#L569)
``` go
...
### <a name="Int.Union">func</a> (\*Int) [Union](github.com/andy2046/goji/int.go?s=11293:11333#L585)
``` go
...
### <a name="Int.Uniq">func</a> (\*Int) [Uniq](github.com/andy2046/goji/int.go?s=11536:11572#L598)
``` go
...
### <a name="Int.Unshift">func</a> (\*Int) [Unshift](github.com/andy2046/goji/int.go?s=6816:6871#L342)
``` go
...
### <a name="Int.Without">func</a> (\*Int) [Without](github.com/andy2046/goji/int.go?s=10470:10520#L541)
``` go
...
## <a name="IntHelper">type</a> [IntHelper](github.com/andy2046/goji/int.go?s=150:249#L14)
``` go
